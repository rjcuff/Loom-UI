...
const EXIT_MS = 160
const ENTER_MS = 220
/** The incoming half waits for the outgoing one to clear out. */
...
export default function HoldButtonDemo() {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="grid place-items-center">
        ...
        <span
          ...
          className={`${SWAP} text-muted-foreground pointer-events-none flex items-center gap-2 text-sm ${
              ...
              ? "translate-y-0 scale-100 opacity-100 delay-[120ms]"
        ...
        {/* The visible confirmation is decoration on a swap; this is the part
            a screen reader is told about, and only when it changes. */}
      ...
      <p
        className={`text-muted-foreground text-xs transition-opacity duration-200 ease-[var(--ease-out-quart)] motion-reduce:transition-none ${
          done ? "opacity-0" : "opacity-100 delay-[120ms]"
        }`}
      >
