...
A spinner says only that something is happening. This one says the same thing in the shape of the work. Warp threads drawn down
the frame one after another, and a shuttle carrying the weft across them.
