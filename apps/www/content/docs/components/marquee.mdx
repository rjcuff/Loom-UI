...
title: Marquee
date: 2026-08-13
description: A scrolling row or column that loops with no visible seam, in either direction, and pauses on hover.
---
...
The fade is a mask, not a gradient overlay. It works over an image, a gradient,
